...
func (app *application) routes() http.Handler {
	...
	mux.Get("/snippet/create", dynamicMiddleware.Append(app.requireAuthentication).ThenFunc(app.snippetCreateForm))
	mux.Post("/snippet/create", dynamicMiddleware.Append(app.requireAuthentication).ThenFunc(app.snippetCreate))
	mux.Get("/snippet/:id", dynamicMiddleware.ThenFunc(app.snippetView))
